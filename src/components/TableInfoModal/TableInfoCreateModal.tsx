 ...
 * @constructor
 * */
export const TableInfoCreateModal :React.FC<PropsWithChildren<Props>> = (props) => {
  ...
  return(
    <Modal destroyOnClose title="保存表信息（后续可直接导入）" open={modalVisible} onCancel={() => onCancel()} footer={null}>
      <Typography.Text type="secondary">注意：你提交的内容可能被公开！</Typography.Text>
      <div style={{marginBottom:16}}>
        <ProTable <TableInfoType.TableInfo,TableInfoType.TableInfo>
        form={{initialValues,submitter:{render:(props,dom) => [...dom.reverse()]}}}

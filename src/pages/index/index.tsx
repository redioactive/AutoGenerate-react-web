import {AutoInputModel} from '@/components/AutoInputModel';
...
const  IndexPage:React.FC = () => {
  ...
  const inputConfigView = (
    <Card title="输入配置" extra={
      <Select defaultValue="MySQL" style={{width:20}} disabled>
    ...
    <Space size="large" wrap>
      ...
      type="primary"
      ghost
      onClick={() => setAutoInputModalVisible(true)}>智能导入</Button>
      <Button onClick={() => setImportTableDrawerVisible(true)}>导入表</Button>
      <Button onClick={() =>setSqlInputModalVisible(true)}>导入建表 SQL</Button>
      <Upload {...uploadProps}>
